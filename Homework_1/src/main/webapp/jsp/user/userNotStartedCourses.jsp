...
<html>
<head>
    <title>Not started courses</title>
...
<div class="mainbackground">
    <table border="1" color="white">
        ...
        <tr>
            ...
            <td style="width: 900px">
                <div>
                    <h2>Курсы ожидающие вашего участия</h2>
                    <table cellpadding="5" border="2">
                        ...
                        <c:forEach items="${listNotStartedCourses}" var="course">
                            <tr>
                                ...
                                <td>${registrationMap.get(course.getCourseId()).isApprove()}</td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
