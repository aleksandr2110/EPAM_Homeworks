...
<div class="mainbackground">
    <table border="1" color="white">
        ...
        <tr>
            ...
            <td style="width: 900px">
                <div>
                    <h2>Информация о законченных курсах на которые вы были зарегистрированы</h2>
                    <table cellpadding="5" border="2">
                        ...
                        <c:forEach items="${listFinishedCourses}" var="course">
                            <tr>
                                <td><a href="/education-faculty.com.ua/user/courses/id=${course.getCourseId()}">${course.getCourseName()}</a></td>
