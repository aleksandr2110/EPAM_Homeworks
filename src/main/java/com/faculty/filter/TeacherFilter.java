...
@WebFilter(dispatcherTypes = {
        ...
        urlPatterns = { "/education-faculty.com.ua/teacher/*",
                "/education-faculty.com.ua/registration/teacher-profile/*",
                "/education-faculty.com.ua/registration/teacher-page/*" },
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if(optionalSession.isPresent()) {
            ...
            if(facultyUserDto.isPresent()) {
                ...
                if (userViewDto.getRole().equals("teacher") && !userBlocked) {
