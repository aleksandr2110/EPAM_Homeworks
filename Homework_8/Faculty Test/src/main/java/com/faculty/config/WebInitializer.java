...
public class WebInitializer implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext container) throws ServletException {
        ...
        //container.addListener(new ContextLoaderListener(contextXml));
        // Создание контекста Spring для сервлета-диспетчера Spring MVC
        AnnotationConfigWebApplicationContext dispatcherContext = new AnnotationConfigWebApplicationContext();
        dispatcherContext.register(WebAppConfig.class);
        //dispatcherContext.register(BasicConfig.class); // лишний
        rootContext.register(BasicConfig.class); // add security config
